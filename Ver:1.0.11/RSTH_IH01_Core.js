/*:
 * @target MZ
 * @plugindesc RSTH_IH: サバイバルゲームシステムプラグイン ver1.0.11
 * @author ReSera_りせら
 *
 * @help
 ...
 * 
 * <autoTile:true>はtrueにするとオートタイルのブロックを設置します。
 * <autoTileRow:0>の数字はオートタイルの画像の何行目のタイルを使うかを指定します。
...
(() => {
  ...
  console.warn("window.RSTH_IH.GrowBlock", window.RSTH_IH.GrowBlock);
