            ...
            if (!hotbar[i]) {
                ...
                if (hotbar[i].type === "block") {
                    ...
                    if (meta) {
                        ...
                        // tileOffsets1 の安全な代入
                        try {
                            hotbar[i].tileOffsets1 = Array.isArray(meta.tileOffsets1) ? meta.tileOffsets1 : JSON.parse(meta.tileOffsets1 || "[]");
                        } catch (e) {
                        ...
                        // tileOffsets2 の安全な代入
                        try {
                            hotbar[i].tileOffsets2 = Array.isArray(meta.tileOffsets2) ? meta.tileOffsets2 : JSON.parse(meta.tileOffsets2 || "[]");
                        } catch (e) {
